...
import campfire.socketio.{ConnectionContext, ConnectionActive}
...
//    StringSerializer.appendToBuilder(builder, cmd.endpoint)
  ...
  final def toSendMessage(bytes: Array[Byte]) = {
    ...
    ConnectionActive.SendMessage(StringSerializer.fromByteIterator(data), StringSerializer.fromByteIterator(data))
  }
...
//    StringSerializer.appendToBuilder(builder, cmd.endpoint)
  ...
  final def toSendJson(bytes: Array[Byte]) = {
    ...
    ConnectionActive.SendJson(StringSerializer.fromByteIterator(data), StringSerializer.fromByteIterator(data))
  }
...
//    StringSerializer.appendToBuilder(builder, cmd.endpoint)
  ...
  final def toSendEvent(bytes: Array[Byte]) = {
    ...
    ConnectionActive.SendEvent(sessionId, name, args)
  }
